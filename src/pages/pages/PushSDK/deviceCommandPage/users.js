...
export default class Users extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      command:'',
      commands:[
            "DATA UPDATE user cardno=20002	pin=1000	password=	starttime=0	endtime=0	name=Keith	superauthorize=0	disable=0",
            "DATA DELETE user pin=1000",
    ...
    return (
      <div hidden={  this.props.onTab === this.state.tab ? false : true } >
          <div className="guidebook">
            <h3> Thao tác người dùng </h3>
            <p>  Phần này là hướng dẩn cho chương trình demo về CURD người dùng trên thiết bị   </p>
