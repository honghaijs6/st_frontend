  ...
  constructor(props){
    ...
    this.state = {
      ...
      commands:[
            ...
            "DATA DELETE userauthorize pin=1000	authorizedoorid=1",
            "DATA QUERY tablename=userauthorize,fielddesc=*,filter =*",
            "DATA COUNT userauthorize"
      ],

      commandActions:[
          'Add / Update Accress Level',
          'Delete Access  Level',
          'Query all Access  Level',
          'Count Access  Level'
      ],
      commandRes:``
    ...
    return (
      <div hidden={  this.props.onTab === this.state.tab ? false : true } >
          <div className="guidebook">
            <h3> Thao tác : Access Level </h3>
            <p>  Phần này là hướng dẩn cho chương trình demo về CURD Access Level trên thiết bị   </p>
